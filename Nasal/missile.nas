...
var MISSILE = {
    new: func(p=0, x=0, y=0, z=0, type="nothing"){
        ...
        m.NameOfMissile     = getprop("su-27/WCS/pylon"~ p ~"/load");
        m.PylonIndex        = p;
        m.ID                = p;
        ...
        # missile specs:
                m.missile_model     =  "Aircraft/SU-27SK/Models/Stores/Missiles/R-27R/R-27R.xml";
                m.missile_NoSmoke   =  "Aircraft/SU-27SK/Models/Stores/Missiles/R-27R/R-27R.xml";
                m.missile_Explosion =  "Aircraft/Mirage-2000/Missiles/MatraMica/explosion.xml";
                m.missile_fov_diam  =		60;
                m.missile_fov       = m.missile_fov_diam  / 2;
                m.max_detect_rng    = 45;
                m.max_seeker_dev    = 55;
                m.force_lbs         = 300;
                m.thrust_duration   = 30;
                m.weight_launch_lbs = 216;
                m.weight_whead_lbs  = 30;
                m.cd                = 0.05;
                m.eda               = 0.043;
                m.max_g             = 100;
                m.maxExplosionRange = 200;
                m.maxSpeed          = 3.5;
                m.Life              = 60;
                m.fox               = "FOX";# for messaging but also for the missile's detection capability (not implemented Yet)
                m.rail              = 1;
                m.cruisealt         = 0;
                m.last_coord       = nil;
